...
//    include('authentication.php');
   ...
   if(isset($_POST['node_add']))
   {
       ...
       $query = "INSERT INTO tc_node (node_name,node_id,node_type,node_location) VALUES 
                 ('$node_name','$node_id','$node_type','$node_location')";

       $query_run = mysqli_query($con,$query);
    
       if($query_run){
           $_SESSION['message'] = "Node Added Successfully";
